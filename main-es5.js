        ...
        value: function buildSingleTitle(item) {
          ...
          if (item.sourceLink) {
            item.sourceLink.forEach(function (link, index) {
              info += "<br/><b>Source Link: </b><a href=\"".concat(link, "\" target=\"_blank\">Link ").concat(index + 1, "</a>");
            });
          }
